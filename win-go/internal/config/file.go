...
func SaveTreemap(path string, t Treemap) error {
	...
	w("treemap.tilePaddingTop", fmtPt(nonzeroOr(t.TilePaddingTopPt, 5)))
	w("treemap.tilePaddingRight", fmtPt(nonzeroOr(t.TilePaddingRightPt, 5)))
	w("treemap.tilePaddingBottom", fmtPt(nonzeroOr(t.TilePaddingBottomPt, 5)))
	...
	w("treemap.headingMinFontSize", fmtPt(nonzeroOr(t.HeadingMinFontSizePt, 8)))

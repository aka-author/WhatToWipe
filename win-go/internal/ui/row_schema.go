...
var treemapSchemas = []RowSchema{
	...
	{Key: "treemap.minTileWidth", Label: "treemap.minTileWidth", Kind: KindNumeric, Min: 1, Max: 4096, Decimals: 0},
	{Key: "treemap.minTileHeight", Label: "treemap.minTileHeight", Kind: KindNumeric, Min: 1, Max: 4096, Decimals: 0},
	{Key: "treemap.tilePaddingLeft", Label: "treemap.tilePaddingLeft", Kind: KindNumeric, Min: 0, Max: 1024, Decimals: 0},
	{Key: "treemap.tilePaddingTop", Label: "treemap.tilePaddingTop", Kind: KindNumeric, Min: 0, Max: 1024, Decimals: 0},
	{Key: "treemap.tilePaddingRight", Label: "treemap.tilePaddingRight", Kind: KindNumeric, Min: 0, Max: 1024, Decimals: 0},
	{Key: "treemap.tilePaddingBottom", Label: "treemap.tilePaddingBottom", Kind: KindNumeric, Min: 0, Max: 1024, Decimals: 0},
	{Key: "treemap.tileFontName", Label: "treemap.tileFontName", Kind: KindDropdown, Options: loadFontOptions()},
	{Key: "treemap.headingMaxFontSize", Label: "treemap.headingMaxFontSize", Kind: KindNumeric, Min: 1, Max: 1024, Decimals: 0},
	{Key: "treemap.headingMinFontSize", Label: "treemap.headingMinFontSize", Kind: KindNumeric, Min: 1, Max: 1024, Decimals: 0},

...
The minimal font size allowed for a label is provided in the `treemap.headingMinFontSize` configuration parameter.
...
A label in the brief form contains the following parts:
